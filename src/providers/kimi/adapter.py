"""OpenAI-compatible adapter for Kimi (Moonshot)."""
...
_PROVIDER_IDENTITY = ProviderIdentity("kimi", "Kimi (Moonshot)", "moonshot.cn")

_DEFAULT_MODEL_IDENTITY = ModelDescriptor(
    model_id="kimi-k3-latest",
    family="kimi",
...
class KimiAdapter(OpenAICompatibleAdapter):
    ...
    def _build_chat_params(self, request: ProviderRequest) -> dict[str, Any]:
        ...
        # Kimi does not support OpenAI-style reasoning_effort parameters.
