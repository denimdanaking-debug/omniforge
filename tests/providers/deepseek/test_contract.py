...
class TestDeepSeekAdapterContract(AdapterContractSuite):
    """Run the provider-neutral contract suite against DeepSeekAdapter."""
...
async def test_deepseek_adapter_uses_default_base_url() -> None:
    adapter = DeepSeekAdapter(api_key="test-key")
