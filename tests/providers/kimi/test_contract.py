...
class TestKimiAdapterContract(AdapterContractSuite):
    """Run the provider-neutral contract suite against KimiAdapter."""
...
async def test_kimi_adapter_uses_default_base_url() -> None:
    adapter = KimiAdapter(api_key="test-key")
