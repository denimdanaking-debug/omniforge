...
class ConfigurationVersioningTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        # Re-register the production Phase 5, Phase 8, Phase 9, and Phase 10 migrations.
        ...
        configuration.register_migration("1.3.0", "1.4.0")(configuration._migrate_1_3_0_to_1_4_0)
    ...
    def test_legacy_config_migrates_to_current_version(self) -> None:
        ...
        self.assertIn("recovery_policy", result)
